...
function insert(num){
    ...
    //Criando uma lista para armazenar os operadores que eu não quero que se repita
    ...
    resultado.innerHTML = numero.innerHTML + num;
...
function back(){
    //Função para apagar o último caractr digitado na tela da calculadora
...
function calcular(){
    var resultado = document.getElementById('resultado').innerHTML;
    if(resultado){
        //Executa se tiver algo digitando no resultado, ou seja, a condição for verdadeiras
        //A função eval atribuída ao elemento resultado, vai avaliar a expressão matemáica e exibir o resultado na tela
